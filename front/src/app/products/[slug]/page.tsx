...
export default async function ProductDetail({ params } : { params:any}) {
  ...
  return (
    <>
    <div className="flex items-center w-full justify-center m-8 h-full">
      <div className="w-1/3 p-10">
        <img src={product?.image} className="w-full"></img>
      </div>
      <div className="flex flex-col justify-between content-between bg-secondary rounded-xl w-1/3 border-border border shadow-md h-[500px]">
