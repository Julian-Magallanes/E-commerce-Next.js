    ...
    return(
        <div>
            ...
            <ul className={`${!dropdownVisible ? "hidden" : "flex flex-col absolute z-10 top-14 right-10 p-5 bg-background w-30 items-center shadow-md rounded-lg"}`}>
                <li className="m-2 cursor-pointer border border-border hover:border hover:shadow-md duration-200 ease-in-out hover:border-font hover:font-bold bg-secondary rounded-md px-4"onClick={handleLogout} >
                Logout
                </li>
            </ul>
        </div>
