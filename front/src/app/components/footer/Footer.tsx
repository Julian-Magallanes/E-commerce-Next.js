...
const Footer:React.FC = ():React.ReactElement =>{
    return(
            <footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4 border-border border">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <a href="./" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                            <img src="https://res.cloudinary.com/dzxrc9b6o/image/upload/v1712441767/Next/logo2_ihseup.png" className="h-8 transition ease-in-out delay-150 hover:scale-110 hover:rotate-12" alt="Logo" />
